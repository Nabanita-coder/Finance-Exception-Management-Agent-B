...
# =========================================================
# TABLE 4: Roles (0: admin, 1: user)
# =========================================================
class Role(Base):
    __tablename__ = "roles"

    id = Column(Integer, primary_key=True, autoincrement=False)  # 0 for Admin, 1 for User
...
class User(Base):
    ...
    def to_dict(self):
        return {
            ...
            "role": self.role.name if self.role else ("admin" if self.role_id == 0 else "user"),
